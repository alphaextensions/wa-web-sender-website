    ...
    return (
        <React.Fragment>
            ...
            <section className="container mx-auto px-8" >
                ...
                <div style={{color: '#1E4F29', fontSize: '16px', textAlign: 'center'}}>WS Basic will be enabled for your number in a few minutes. You will receive a confirmation email soon.</div>
