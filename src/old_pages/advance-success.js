...
function AdvanceSuccessPage() {
    const title =
        'Advance Success | Web Sender';
    const description =
        'Advance Success for Web Sender';
    return (
        <React.Fragment>
            <Helmet>
                <html lang="en" />
            ...
            <section className="container mx-auto px-8" >
                ...
                <div style={{color: '#1E4F29', fontSize: '12px', textAlign: 'center', marginTop: '8px'}}>If Premium is not enabled, do not worry. Please click on 'Live Support' button on the top left of the extension.</div>
...
export default AdvanceSuccessPage;
